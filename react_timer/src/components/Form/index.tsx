...
export default class Form extends React.Component<{setTasks: React.Dispatch<React.SetStateAction<TypeTask[]>>}> {
    ...
    createTask(e: React.FormEvent) {
        ...
        this.props.setTasks(oldTasks => [...oldTasks, { ...this.state }]) // seta as tasks antigas + as atuais; essa função já recebe como parâmetro (oldTask) o estado antigo
    }
            ...
            {/* onSubmit: servirá para pegar o estado e mandar para outro lugar (list) */}
                <div className={style.inputContainer}>
                    ...
                    <input 
                        ...
                        onChange={(e) => this.setState({ ...this.state, task: e.target.value})} // estado que permite a mudança do input, sempre pegando o valor do evento
                        required
                    />
                </div>
                <div className={style.inputContainer}>
                    ...
                    <input 
                        ...
                        onChange={(e) => this.setState({ ...this.state, time: e.target.value})} // estado que permite a mudança do input, sempre pegando o valor do evento
                        required
                    />
                </div>
                <Button 
